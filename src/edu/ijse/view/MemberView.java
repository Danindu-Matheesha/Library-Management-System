...
public class MemberView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Member RegisterDate");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtPhNo, javax.swing.GroupLayout.PREFERRED_SIZE, 302, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void saveMember() {
        MemberDto dto = new MemberDto(txtId.getText(), txtName.getText(), txtAddress.getText(),
                Integer.parseInt(txtPhNo.getText()), txtDOB.getText(), txtdate.getText());
        //String resp;
        try {
    ...
    private void loadTable() {
        try {
            String columns[] = { "Member ID", "Member Name", "Address", "Phone NO", "DOB", "RegisterDate" };
            ...
            for (MemberDto dto : memberDtos) {
                Object[] rowDate = { dto.getMemberId(), dto.getName(), dto.getAddress(), dto.getPhoneNO(), dto.getDBO(),
                        dto.getRegisterDate() };
                dtm.addRow(rowDate);
            }
        } catch (Exception e) {
    ...
    private void searchMember() {
        try {
            ...
            if (dto != null) {
                ...
                txtPhNo.setText(Integer.toString(dto.getPhoneNO()));
                txtDOB.setText(dto.getDBO());
                txtdate.setText(dto.getRegisterDate());
            } else {
    ...
    private void updateMember() {
        try {
            MemberDto memberDto = new MemberDto(txtId.getText(), txtName.getText(), txtAddress.getText(),Integer.parseInt(txtPhNo.getText()), txtDOB.getText(), txtdate.getText());
