...
public class MemberView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblMember.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
    ...
    private void saveMember() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error At Add Member");
        }
    ...
    private void loadTable() {
        try {
            ...
            for (MemberDto dto : memberDtos) {
                Object[] rowDate = { dto.getMemberId(), dto.getName(), dto.getAddress(), dto.getPhoneNO(), dto.getDOB(),dto.getRegisterDate()};
                dtm.addRow(rowDate);
            }
        } catch (Exception e) {
